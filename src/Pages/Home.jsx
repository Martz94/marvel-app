...
const Home = () => {
  ...
  return (
    <div className="container mt-11 sm:mt-14">
      <div className=' bg-zinc-800 py-6 mb-10 right-0 left-0'>
        <h2 className="text-4xl md:text-5xl text-center md:text-start mx-auto w-auto md:max-w-6xl px-2 md:me-auto font-bold bg-gradient-to-r from-neutral-500 to-red-900 bg-clip-text text-transparent">
          Marvel Universe
        </h2>
      </div>
